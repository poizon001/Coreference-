...
# tre=[[{u'node': u'-> friend-NN (root)', u'subTree': [{u'node': u'  -> Kumar-NNP (nsubj)', u'subTree': [{u'node': u'    -> Ramesh-NNP (nn)', u'subTree': []}, {u'node': u'    -> and-CC (cc)', u'subTree': []}, {u'node': u'    -> Kumar-NNP (conj)', u'subTree': [{u'node': u'      -> Mohan-NNP (nn)', u'subTree': []}]}]}, {u'node': u'  -> are-VBP (cop)', u'subTree': []}]}]]

# sub = "Kumar-NNP (nsubj)"

# print fullnnp(tre[0], sub)