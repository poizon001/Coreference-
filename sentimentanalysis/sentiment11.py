...
positives = open("/media/shive/New Volume/Untitled Folder/sentimentanalysis/data/positives.txt").read().split("\n")
negatives = open("/media/shive/New Volume/Untitled Folder/sentimentanalysis/data/negatives.txt").read().split("\n")
...
def get_np(tree, origtree):
	...
	for subTree_dic in tree:
		...
		# print "strn>>>>", strn
		# print "lll>>>", get_level(orig_node)
		# print "or->", orig_node.find(strn)
