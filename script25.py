					...
					if len(words) > 1:
						...
						for p in pos:
							...
							# if p[1] == "NNS":
								...
								idx2 = get_index(lst_np_hw_sentnum_npnum, j, i, id_dict[j.lower()])
								# print "idx"
								# print idx1
								# print idx2
					...
					for k in (range(idx)):
						...
						if k < idx:
					 	...
					 	if c > 1:
					 		...
					 		idx1 = get_index(lst_np_hw_sentnum_npnum, j, i, id_dict[j.lower()])
					 		# print "tttt", t
				...
				if n >= 0:
					...
					for k in reversed(range(len(np_lst_up))):
						...
						if pos == "NNP" and rel == "nsubj":
							...
							print "w1 ", w1
							FLAG = 1
							idx1 = get_index(lst_np_hw_sentnum_npnum, w, l, id_dict[w.lower()])
			...
			if w.lower() in singularPronounsNoMF:
				...
				for idx in range(i):
					...
					if pos == "NNP" and rel == "nsubj":
						...
						idx2 = get_index(lst_np_hw_sentnum_npnum, w1, l, id_dict[w1.lower()])
						print "idx"
						print idx1
						print idx2
						for ll in lst_np_hw_sentnum_npnum:
...
if __name__ == "__main__":
	...
	lst_of_sentences = get_sentences("data8.txt")
