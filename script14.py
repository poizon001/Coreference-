...
otherPronouns = ["who", "whom", "whose", "when","which"]
...
neutralPronouns1 = ["here", "there","where"]
...
def corefer_plural_up(lst_of_sent, lst_sent_np, lst_np_rel_sent, start_sent, level_up, last_name, prp_word, lst_ner_dict):
	...
	for i in reversed(range(n)):
		...
		for j in reversed(lst_sent_np[i]):
			...
			if j.lower() in pluralPronouns:
				...
				if FLAG == 0:
					print "\n going upwards \n"
					corefer_plural_up(lst_of_sent, lst_sent_np, lst_np_rel_sent, i, 3, last_name, j, lst_ner_dict)
...
def corefer_neutral1_up(start_sent, prp_idx, level_up, lst_of_sent, lst_sent_np, lst_np_hw_sentnum_npnum, lst_np_rel_sent, lst_ner_dict):
...
def pronoun_neutral1(lst_of_sent, lst_sent_np, lst_np_hw_sentnum_npnum, lst_np_rel_sent, lst_ner_dict):
		...
		for j,k in enumerate(lst_words):
			...
			if k.lower() in neutralPronouns1:
				...
				if flag == 0:
					...
					lst_of_sent = corefer_neutral1_up(i, j, 3, lst_of_sent, lst_sent_np, lst_np_hw_sentnum_npnum, lst_np_rel_sent, lst_ner_dict)
...
if __name__ == "__main__":
	...
	lst_of_sent = pronoun_neutral1(lst_of_sent, lst_sent_np, lst_np_hw_sentnum_npnum, lst_np_rel_sent, lst_ner_dict)
